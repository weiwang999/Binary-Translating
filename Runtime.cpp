...
Memory *__remill_async_hyper_call(
  //  State &state, Memory *mem, AsyncHyperCall::Name call
  ...
  auto rax = state.gpr.rax.aword;
  auto rbx = state.gpr.rbx.aword;
  auto rcx = state.gpr.rcx.aword;
  auto rdx = state.gpr.rdx.aword;
  auto rsi = state.gpr.rsi.aword;
  auto rdi = state.gpr.rdi.aword;
  auto r8 = state.gpr.r8.aword;
  auto r9 = state.gpr.r9.aword;
  auto r10 = state.gpr.r10.aword;
  auto call = state.hyper_call;
    ...
    case AsyncHyperCall::kX86SysEnter:
{
      asm volatile(
          "syscall"
          : "=a"(state.gpr.rax.dword)
          /*  "=D"(state.gpr.rdi.dword),
            "=S"(state.gpr.rsi.dword),
            "=d"(state.gpr.rdx.dword),
            "=10"(state.gpr.r10.dword),
            "=8"(state.gpr.r8.dword),
            "=9"(state.gpr.r9.dword)*/
          : "a"(eax),
            "b"(ebx),
            "c"(ecx),
            "d"(edx),
  ...
  case AsyncHyperCall::kX86SysCall:
{
      ...
      register unsigned long reg_r10 asm("r10") = r10;
      register unsigned long reg_r8 asm("r8") = r8; 
      register unsigned long reg_r9 asm("r9") = r9; 
      asm volatile(
          "syscall"
          : "=a"(ret_val)
          /*  "=D"(state.gpr.rdi.dword),
